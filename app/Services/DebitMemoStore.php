...
class DebitMemoStore implements TransactionStoreInterface 
{
	...
	public function save()
	{
		...
		//1. validate receipt
		$this->pre->validatedebitmemo($this->transaction); 
		...
		//2. Store Data debitmemo
		$this->pro->storedebitmemo($this->transaction); 
