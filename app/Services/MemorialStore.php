...
class MemorialStore implements TransactionStoreInterface 
{
	...
	public function save()
	{
		...
		//1. validate receipt
		$this->pre->validatememorial($this->transaction); 
		...
		//2. Store Data memorial
		$this->pro->storememorial($this->transaction); 
