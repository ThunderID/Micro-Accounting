...
class InvoiceStore implements TransactionStoreInterface 
{
	...
	public function save()
	{
		...
		//1. validate receipt
		$this->pre->validateinvoice($this->transaction); 
		...
		//2. Store Data invoice
		$this->pro->storeinvoice($this->transaction); 
