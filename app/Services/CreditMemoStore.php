...
class CreditMemoStore implements TransactionStoreInterface 
{
	...
	public function save()
	{
		...
		//1. validate receipt
		$this->pre->validatecreditmemo($this->transaction); 
		...
		//2. Store Data creditmemo
		$this->pro->storecreditmemo($this->transaction); 
