...
class ReceiptStore implements TransactionStoreInterface 
{
	...
	public function save()
	{
		...
		//1. validate receipt
		$this->pre->validatereceipt($this->transaction); 
		...
		//2. Store Data Receipt
		$this->pro->storereceipt($this->transaction); 
